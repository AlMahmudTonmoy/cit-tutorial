                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc required'>
                                <input type="hidden" name="all_previous_data" value="{{ json_encode($all_previous_data) }}">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now (${{ $total_to_pay }} )</button>
                            </div>
                        </div>
